//INGRESAR EDAD, NOMBRE Y APELLIDO HASTA QUE LA EDAD SEA MENOR A 18. SE MUESTRA POR CONSOLA: NOMBRE,APELLIDO Y EDAD, SOLO DE LOS MAYORES. ALERTA CUANDO ES MENOR A 18.
/*let nombre;
let apellido;
let edad;
do{
